...
class ControladorUsuarios{
		...
		if(isset($_POST["regUsuario"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				// título
				$titulo = 'Por favor verifique su dirección de correo electrónico';
				...
				$mensaje = '<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
					...
					<center>
						...
						<img style="padding:20px; width:10%" src="http://localhost/ecommerceV1/backend/vistas/img/plantilla/logo.png">
					...
					<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
						...
						<img style="padding:20px; width:15%" src="http://localhost/ecommerceV1/backend/vistas/img/plantilla/icon.png">
				...
				$cabeceras .= 'From: Registro <registro@tutiendaenlinea.com>' . "\r\n";
	...
	public function ctrActualizarEnvio(){
		...
		$datos = array("calle" => $_POST["editarCalle"],
			...
			$respuesta = ModeloUsuarios::mdlActualizarEnvio($tabla, $datos);
			...
			if($respuesta == "ok"){
				...
				echo '<script>
						...
						swal({
							  title: "¡OK!",
							  text: "¡Los datos de envio se han actualizado correctamente!",
							  type:"success",
							  confirmButtonText: "Cerrar",
							  closeOnConfirm: false
							},
