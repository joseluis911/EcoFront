	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
	  		...
	  		<li>
				...
				<li>
	  			<a data-toggle="tab" href="#envio">
	  			<i class="fa fa-truck"></i> DIRECCIÓN DE ENVIO</a>
	  		</li>
								...
								echo '<div class="panel panel-default">
									    ...
									    <div class="panel-body">
											...
											<div class="col-sm-6 col-xs-12">
							                   ...
							                   <div class="progress-bar bg-primary progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 33%">
							                   <span class="sr-only">40% Complete (success)</span>
														...
														// 		<i class="fa fa-check"></i> Validando Compra
														// 	</div>
														//
					...
					<div class="row">
						...
						<form method="post" enctype="multipart/form-data">
							...
							<?php
								...
								$actualizarEnvio = new ControladorUsuarios();
								$actualizarEnvio->ctrActualizarEnvio();
