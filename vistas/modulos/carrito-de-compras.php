		...
		<div class="modal-body modalTitulo">
          ...
          <?php
                ...
                if ($_SESSION["calle"] != "") {
                  ...
                  echo '<p class="text-center well text-uppercase"> Dirección de envio: '.$_SESSION["calle"].', '.$_SESSION["colonia"].', '.$_SESSION["municipio"].', C.P. '.$_SESSION["cp"].'</p>
                  ...
                  echo '<p class="text-center well text-uppercase text-primary">Por favor ingresa tu dirección de envio en <br /><a></a> <strong>VER PERFIL > DIRECCIÓN DE ENVIO</strong></p>';
          ...
          if($_SESSION["calle"] != ""){
            ...
            echo '<button class="btn btn-block btn-lg btn-default muted backColor btnPagar">PAGAR</button>';

          }else{

            echo '<button  class="btn btn-block btn-lg btn-default muted backColor disabled">PAGAR</button>';
